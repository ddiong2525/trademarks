...
6. 개선할 부분 및 다짐
<br>이번 프로젝트를 통해 Next.js 및 전역 상태 관리와 같은 익숙하지 않은 기술을 적극적으로 학습하고 적용하는 경험을 쌓았습니다. 초기에는 다소 어려움이 있었지만, 꾸준한 탐구와 문제 해결 과정을 통해 목표를 완수할 수 있었습니다.
<br>앞으로도 새로운 기술을 빠르게 습득하고 프로젝트에 효과적으로 적용할 수 있도록 노력하며, 보다 나은 코드 품질과 사용자 경험 개선에 집중하고자 합니다. 감사합니다.